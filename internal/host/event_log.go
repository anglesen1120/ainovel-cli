...
// Ghi một sự kiện UI / thời gian chạy qua logger của tiến trình. Summary là văn bản hiển thị;
// Detail là chẩn đoán đầy đủ, chỉ cần tồn tại thì sẽ dùng làm nội dung nhật ký.
