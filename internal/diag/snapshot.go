...
// Snapshot là bản chụp chỉ đọc của toàn bộ tài sản trong thư mục output.
...
type Snapshot struct {
	...
	LoadErrors []string // Các lỗi tải không phải NotExist, phân biệt "không có dữ liệu" và "đọc lỗi"
}

// Load đọc toàn bộ tài sản từ store để dựng snapshot chỉ đọc.
// Tệp không tồn tại được xem là "không có dữ liệu" (trường giữ giá trị zero); các lỗi khác sẽ được ghi vào LoadErrors.
