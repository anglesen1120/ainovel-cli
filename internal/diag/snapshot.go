...
// Snapshot là ảnh chụp chỉ đọc của toàn bộ công cụ trong thư mục output.
...
type Snapshot struct {
	...
	LoadErrors []string // Lỗi tải không phải NotExist, phân biệt "không có dữ liệu" và "lỗi đọc"
}

// Load đọc toàn bộ công cụ từ store và dựng ảnh chụp chỉ đọc.
// Tệp không tồn tại được xem là "không có dữ liệu" (trường giữ giá trị zero); lỗi khác ghi vào LoadErrors.
...
// LatestCompleted trả về số chương đã hoàn thành lớn nhất; nếu không có thì 0.
