...
func TestReplaceExecutable(t *testing.T) {
	...
	// Việc khẳng định bảo toàn quyền chỉ có ý nghĩa trên các nền tảng có ngữ nghĩa
	// bit quyền POSIX: Windows báo mọi thứ là 0666/0444, không bao giờ có bit thực thi
	// (tính khả thực thi đến từ phần mở rộng .exe), nên khẳng định này luôn sai trên nền tảng đó.
	// Các khẳng định về thay thế/khôi phục/dọn dẹp bản sao lưu phụ thuộc nền tảng
	// (ngữ nghĩa rename của Windows khác), vì vậy vẫn phải tiếp tục chạy.
