...
// gen_models.go kéo toàn bộ model từ OpenRouter API và tạo baseline lúc biên dịch models_generated.go.
...
const (
	...
	// maxModelAgeDays quyết định baseline giữ model cũ đến mức nào. Quá tuổi này bị xem là lỗi thời
	// như GPT-3.5, GPT-4 bản gốc, Llama 2, Mistral 7b, rồi bị loại để giảm kích thước nhị phân và nhiễu tra cứu.
	// Giữ nhất quán với bộ lọc runtime trong pricing.go.
	maxModelAgeDays = 730
)
...
// isTooOld kiểm tra timestamp created có vượt maxModelAgeDays không.
